        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="w-12 h-12 bg-primary-100 dark:bg-primary-900 rounded-lg flex items-center justify-center mb-4">
              <el-icon class="text-primary-600 dark:text-primary-400" size="24"><Document /></el-icon>
            </div>
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">优质内容</h3>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="w-12 h-12 bg-primary-100 dark:bg-primary-900 rounded-lg flex items-center justify-center mb-4">
              <el-icon class="text-primary-600 dark:text-primary-400" size="24"><Cpu /></el-icon>
            </div>
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">实用代码</h3>
            <p class="text-gray-600 dark:text-gray-300">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="w-12 h-12 bg-primary-100 dark:bg-primary-900 rounded-lg flex items-center justify-center mb-4">
              <el-icon class="text-primary-600 dark:text-primary-400" size="24"><ChatDotRound /></el-icon>
            </div>
            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">互动交流</h3>
            <p class="text-gray-600 dark:text-gray-300">
